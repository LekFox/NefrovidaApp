...
class Quiz1Questions : AppCompatActivity() {
    ...
    private fun setQuestion() {
        ...
        tv_progress.text = question.optionOne
        tv_progress.text = question.optionTwo
        tv_progress.text = question.optionThree
        tv_progress.text = question.optionFour
